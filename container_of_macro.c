...
/*
    ...
    the offset of macro returns the 'OFFSET' of member relative 
    to a given structure WITHOUT creating an instance or a pointer of a structure

    #define OFFSET_OF(yupr, mem) (unsigned long long int)(&(((type*)0)->mem))

*/

/*
    container of macro:
    you have been given a structure name, member name and address of the member 
    ...
    addr is address of 'c' field of one of the structure instances
*/
